...
framesInDax = infoFile.numberOfFrames;
...
frameDim = [infoFile.frameDimensions(1)/infoFile.binning(1),...
            infoFile.frameDimensions(2)/infoFile.binning(2)];
...
if DoThis
    ...
    if ~isempty( strfind(infoFile.dataType,'little endian') );
        binaryFormat = 'l';
    else
        binaryFormat = 'b';
    end
